...
ham_characters = ['Ham', 'Oph', 'Hor', 'Ros', 'Guil', 'Pol']
analyze_all_characters(romeo_characters, load_romeo())
analyze_all_characters(ham_characters, load_hamlet())
